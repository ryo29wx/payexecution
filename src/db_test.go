...
const (
	...
	insertQuery = "INSERT INTO PRODUCT_INFO(product_id, product_name, seller_id, stock, category, price, rate) VALUES ('test_productID', 'test_productName', 'test_sellerID', 5, 1, 100, 10)"
)
